...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('nullAddress: ${addressCubit.address}');
...
class _LoadedWidgetState extends State<_LoadedWidget> {
  ...
  load() {
    ...
    if (Utils.isMapEnable(context) &&
        ...
        checkoutResponseModel!.addresses.isNotEmpty) {
      deliveryCubit.addDistancePerKM(
          checkoutResponseModel!.addresses.first.distance,
          checkoutResponseModel!.addresses.first.priceRange);

      billingAddressId = checkoutResponseModel!.addresses.first.id;
      shippingAddressId = checkoutResponseModel!.addresses.first.id;
              ...
              children: [
                BlocBuilder<DeliveryChargesCubit, ShippingResponseModel>(
                  builder: (context, state) {
                    ...
                    return Text(
                      "${Language.total.capitalizeByWord()}: ${convertPrice(price)}",
                  ...
                  //buildWhen: (previous,current)=>!Utils.isMapEnable(context),
                ),
                Text(
  ...
  Widget _buildLocation() {
    ...
    return Column(
      children: [
        ...
        if (Utils.isMapEnable(context)) ...[
          _scrollingAddress(context, checkoutResponseModel!.addresses),
        ] else ...[
