                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                       ...
                       const CustomText(text: 'Continue with Google',fontWeight: FontWeight.w600,fontSize: 14.0,color: blackColor)
                      ],
                    ),
                  ),
                );
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: blackColor.withOpacity(.5),fontSize: 15.0),
                  ),
                ],
              ),
              InkWell(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: redColor,fontWeight: FontWeight.w500),
                ),
              ),
            ],
          ),
