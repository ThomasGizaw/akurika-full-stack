  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<OrderCubit, ProductStateModel>(
      builder: (context, state) {
        final tabs = [
          'All ${Language.order.capitalizeByWord()} (${bCubit.orderList.length})',
          '${Language.pending.capitalizeByWord()} (${bCubit.pending.length})',
          '${Language.progress.capitalizeByWord()} (${bCubit.progress.length})',
          '${Language.delivered.capitalizeByWord()} (${bCubit.delivered.length})',
          '${Language.completed.capitalizeByWord()} (${bCubit.completed.length})',
          '${Language.declined.capitalizeByWord()} (${bCubit.declined.length})',
        ];
        return Container(
