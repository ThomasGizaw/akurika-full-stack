        ...
        <div class="wsus__wizard_body">
            ...
            <div class="wsus__wizard_main_content">
                <ul>
                    ...
                    <li><span>Bootstrap File</span><a class="replace_btn" href="javascript:;" data-action_type="replace_bootstrap_file">Update</a></li>

                    <li><span>Config File</span><a class="replace_btn" href="javascript:;" data-action_type="replace_config_file">Update</a></li>

                    <li><span>Update Custom Files</span><a class="replace_btn" href="javascript:;" data-action_type="replace_custom_file">Update</a></li>
                    ...
                    <li><span>Update Vendor Files</span>
                    <strong>It can take more time than others</strong><a class="replace_btn" href="javascript:;" data-action_type="replace_vendor_zip_file">Update</a></li>

                    <li><span>Migrate Database</span><a class="run_migration" href="javascript:;">Update</a></li><br><br>
            ...
            <!-- <p class="settings">After successfully update all of above files, go to your admin panel, <span>Settings > Database Generate</span> . Update database change to work properly with the update.</span>
                ...
                <p class="copyright">© 2024 All Right Reserved By <b>Quomodothemes</b></p>
            </div>
        </div>
    </div>
...
<script>
     ...
     $(".run_migration").on("click", function(e) {
            ...
            let origin_url = modifiedURL + "/run_migration";
