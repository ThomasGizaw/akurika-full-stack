   ...
   private $client;
    ...
    public function payWithPaypal(Request $request){
        ...
        $orderRequest->body = [
            ...
            'application_context' => [
                'return_url' => $root_url."/user/checkout/paypal-payment-success",
                'cancel_url' => $root_url."/user/checkout/paypal-payment-cancled",
    ...
    public function paypalPaymentSuccess(Request $request)
     {
        ...
        try {
            ...
            if ($response->result->status === 'COMPLETED') {
                ...
                $total = $this->calculateCartTotal($user, $request->coupon, $shipping_method_id, $shipping_address_id);
